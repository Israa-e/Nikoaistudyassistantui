  ...
  return (
    <div className="min-h-screen bg-[#0F0F14] px-6 pt-8 pb-6">
      ...
      {uploadState === "idle" && (
        ...
        >
          ...
          <div
            ...
            className="border-2 border-dashed border-white/20 rounded-3xl p-12 flex flex-col items-center justify-center cursor-pointer hover:border-[#6B5FFF] hover:bg-[#1A1A22]/30 transition-all min-h-[300px]"
          >
            <div className="w-20 h-20 bg-[#6B5FFF]/20 rounded-2xl flex items-center justify-center mb-6">
              <Upload className="w-10 h-10 text-[#6B5FFF]" />
            </div>
            <h3 className="text-white font-semibold text-xl mb-2">Drop your PDF here</h3>
            <p className="text-[#B8B8C7] text-center mb-6">
              or click to browse files
            </p>
            <button className="bg-[#6B5FFF] hover:bg-[#8B75FF] text-white px-6 py-3 rounded-xl font-medium transition-all">
              Choose File
            </button>
          </div>
              ...
              {[
                ...
                >
                  <div className="w-12 h-12 bg-[#232334] rounded-xl flex items-center justify-center">
                    <FileText className="w-6 h-6 text-[#6B5FFF]" />
                  </div>
      ...
      {uploadState === "processing" && (
        ...
        >
          <div className="w-24 h-24 bg-gradient-to-br from-[#6B5FFF] to-[#A855F7] rounded-2xl flex items-center justify-center mb-6 relative">
            <motion.div
              animate={{ rotate: 360 }}
            ...
            {["Extracting text", "Identifying topics", "Generating summary"].map((step, index) => (
              ...
              >
                <motion.div
                  ...
                  className="w-5 h-5 bg-[#6B5FFF] rounded-full flex items-center justify-center"
                >
        ...
        >
          ...
          <div className="bg-[#1A1A22]/50 backdrop-blur-xl border border-white/10 rounded-3xl p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-[#6B5FFF]/20 rounded-xl flex items-center justify-center">
                <Sparkles className="w-5 h-5 text-[#6B5FFF]" />
              </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="bg-[#6B5FFF] hover:bg-[#8B75FF] text-white py-4 rounded-2xl font-semibold transition-all">
              Generate Quiz
            </button>
